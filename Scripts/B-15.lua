loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/DOORS-Entity-Spawner/refs/heads/main/init.luau"))()

local MyEntity = Spawner:Create({
    Entity = {
        Name = "B-15",
        Asset = "https://github.com/AirSuper1/Doors-Model-RBXM/blob/main/Entity/B-15.rbxm?raw=true",
        HeightOffset = 0
    },
    Movement = {
        Speed = 100,
    ...
    Death = {
        ...
        Hints = {"Hi...", "What did you die of this time?", "Um...", "B-15?","HOW ON EARTH DID YOU DIE FROM THAT?!"," YOU DIED JUST TO PISS ME OFF!", "YOU KNOW WHAT I THINK ABOUT YOU?", "Just get the hell out of here."},
        Cause = "B-15"
    }
})
